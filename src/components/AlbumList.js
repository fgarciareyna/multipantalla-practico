...
import { FlatList, Text, View, Picker, Item } from 'react-native';
...
class AlbumList extends Component {
  ...
  renderUsers = () => {
    return (
      ...
      <Picker
          ...
          <Picker.Item label="User 132822455@N05" value="132822455@N05" />
        </Picker>
        </View>
        );
  };
  ...
  render() {
    if (!this.state.photoset && this.state.searched === true) { 
			return (
			  <View>
					<Text>
            No Images Found
